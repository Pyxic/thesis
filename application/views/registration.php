...
<body class="bg-color-light">
        <div class="container h-100 registration" style="margin-top:5%">
            <div class="h-100 justify-content-center align-items-center">
                    <form method="POST" role='form' action="/diplom/index.php/registration/addUser">
                          ...
                          <br>
                            ...
                            <div class="form-group row h-100 justify-content-center align-items-center">
                                    ...
                                    <div class="col-sm-4">
                                      <input type="text" name ="nameCompany" class="form-control" id="NameCompany" placeholder="Название компании">
                                    </div>
                            </div>
